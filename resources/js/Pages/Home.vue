      ...
      <ul class="list-group">
        <li v-for="todo in todos" :key="todo.id"
          ...
          <div>
            ...
            <button class="badge me-2 " :class="todo.completed ? 'bg-success' : 'bg-secondary'"
              @click="updatestatus(todo.id)" style="cursor: pointer">
          ...
          <div class="">
            ...
            <button class="btn btn-info me-2" @click="updatestatus(todo.id)">
              Update status
            </button>
