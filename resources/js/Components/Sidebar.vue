  ...
  <div class="d-flex flex-column vh-100">
    ...
    <header class="navbar navbar-dark bg-primary px-4">
      ...
      <div class="dropdown">
        ...
        <!-- Dropdown Menu -->
        <div v-if="showNotifications" class="dropdown-menu dropdown-menu-end p-3 shadow show" style="width: 300px; max-height: 350px; overflow-y: auto; right: 0;">
    ...
    <div class="d-flex flex-grow-1">
      <!-- Sidebar -->
      <div class="bg-dark text-white d-flex flex-column" :style="{ width: isVisible ? '220px' : '50px', transition: 'width 0.3s' }">
